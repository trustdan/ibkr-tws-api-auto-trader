...
def check_strategy_params():
    ...
    assert 'sma_period' in config['strategy'], "sma_period setting missing from strategy config"
    assert 'candle_count' in config['strategy'], "candle_count setting missing from strategy config"
    assert 'otm_offset' in config['strategy'], "otm_offset setting missing from strategy config"
    assert 'iv_threshold' in config['strategy'], "iv_threshold setting missing from strategy config"
    assert 'min_reward_risk' in config['strategy'], "min_reward_risk setting missing from strategy config" 